        ...
        <View style={styles.cardsContainer}>
            {
                data.map((item, index) => {
                    return (
                        <TouchableOpacity key={index} activeOpacity={0.7} style={styles.subcontainer} onPress={() => navigation.navigate('/TrackDetails')}>
                            <View style={styles.detailsWrap}>
                                ...
                                <View style={styles.details}>
                                    ...
                                    <Text style={styles.tracks}>Popularity: {item?.popularity}</Text>
                                </View>
